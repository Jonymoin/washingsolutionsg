  ...
  "Motor Issues": {
    ...
    items: [
      ...
      },
      {
        ...
        severity: "high",
        emoji: "🔩",
        image: "/images/wmt2.webp",        imgAlt: "Washing machine motor coupling",
        description:
      ...
      },
      {
        ...
        severity: "critical",
        emoji: "⚡",
        image: "/images/wmt3.webp",        imgAlt: "Electric motor repair",
        description:
      ...
      },
      {
        ...
        severity: "medium",
        emoji: "🎯",
           image: "/images/wmt4.webp",        imgAlt: "Pulley mechanism",
        description:
      ...
      },
      {
        ...
        severity: "high",
        emoji: "🔘",
        image: "/images/wmt5.webp",        imgAlt: "Bearing replacement",
        description:
    ...
    items: [
      {
        ...
        severity: "critical",
        emoji: "🖥️",
image: "/images/wmt6.webp",        imgAlt: "PCB circuit board",
        description:
      ...
      },
      {
        ...
        severity: "medium",
        emoji: "🔘",
image: "/images/wmt7.webp",        imgAlt: "Electrical switch",
        description:
      ...
      },
      {
        ...
        severity: "medium",
        emoji: "🚪",
image: "/images/wmt8.webp",        imgAlt: "Washing machine door",
        description:
      ...
      },
      {
        ...
        severity: "medium",
        emoji: "🔋",
image: "/images/wmt9.webp",        imgAlt: "Capacitor components",
        description:
      ...
      },
      {
        ...
        severity: "low",
        emoji: "💡",
image: "/images/wmt10.webp",        imgAlt: "Electrical fuse",
        description:
    ...
    items: [
      {
        ...
        severity: "high",
        emoji: "🚿",
image: "/images/wmt11.webp",        imgAlt: "Drain pump",
        description:
      ...
      },
      {
        ...
        severity: "low",
        emoji: "🪠",
image: "/images/wmt12.webp",        imgAlt: "Drainage hose",
        description:
      ...
      },
      {
        ...
        severity: "medium",
        emoji: "🚰",
image: "/images/wmt13.webp",        imgAlt: "Water inlet valve",
        description:
      ...
      },
      {
        ...
        severity: "low",
        emoji: "🔍",
image: "/images/wmt14.webp",        imgAlt: "Washing machine filter",
        description:
      ...
      },
      {
        ...
        severity: "medium",
        emoji: "🔧",
image: "/images/wmt15.webp",        imgAlt: "Hose fittings plumbing",
        description:
      ...
      },
      {
        ...
        severity: "high",
        emoji: "🔵",
image: "/images/wmt16.webp",        imgAlt: "Door seal rubber gasket",
        description:
